...
//-------
        ...
        // Build flowers
        //
        let PS: u8 = 14;  // petals count
        let M1S: u8 = 8;  // miolos1 count
        let M2S: u8 = 10; // miolos2 count
        // number of asters
        ...
        while i < aster_count {
            ...
            let p2: u8 = p1 + props.seeder.get_next_u8(PS-p1+1);
